...
public static class HashCode
{
	...
	public static unsafe int Get<T>([AllowNull] T obj) => FunctionPointers.GetHashCode<T>.Default(obj!);

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static unsafe int Get<T>([AllowNull] ref T obj) => FunctionPointers.GetHashCodeByRef<T>.Default(ref obj!);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static int Combine(int first, int second, int third) => Combine(first, second).CombineWith(third);

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static int Combine<T_first, T_second, T_third, T_fourth>(T_first first, T_second second, T_third third,
			T_fourth fourth)
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	internal static int CombineWith(this int first, int second) => unchecked((first * 9176) + second);

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	internal static int CombineWith<T>(this int first, T second)
		//where T : notnull
